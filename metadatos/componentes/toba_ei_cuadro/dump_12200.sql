...
INSERT INTO apex_objeto (proyecto, objeto, anterior, identificador, reflexivo, clase_proyecto, clase, punto_montaje, subclase, subclase_archivo, objeto_categoria_proyecto, objeto_categoria, nombre, titulo, colapsable, descripcion, fuente_datos_proyecto, fuente_datos, solicitud_registrar, solicitud_obj_obs_tipo, solicitud_obj_observacion, parametro_a, parametro_b, parametro_c, parametro_d, parametro_e, parametro_f, usuario, creacion, posicion_botonera) VALUES (
	...
	'RRecepción - Cuadro', --nombre
	'Facturas de Venta', --titulo
	'0', --colapsable
	NULL, --descripcion
...
INSERT INTO apex_objeto_eventos (proyecto, evento_id, objeto, identificador, etiqueta, maneja_datos, sobre_fila, confirmacion, estilo, imagen_recurso_origen, imagen, en_botonera, ayuda, orden, ci_predep, implicito, defecto, display_datos_cargados, grupo, accion, accion_imphtml_debug, accion_vinculo_carpeta, accion_vinculo_item, accion_vinculo_objeto, accion_vinculo_popup, accion_vinculo_popup_param, accion_vinculo_target, accion_vinculo_celda, accion_vinculo_servicio, es_seleccion_multiple, es_autovinculo) VALUES (
	...
	'doc.gif', --imagen
	'0', --en_botonera
	'Ver Información completa del Servicio', --ayuda
	'1', --orden
	NULL, --ci_predep
	'0', --implicito
	NULL, --defecto
...
INSERT INTO apex_objeto_eventos (proyecto, evento_id, objeto, identificador, etiqueta, maneja_datos, sobre_fila, confirmacion, estilo, imagen_recurso_origen, imagen, en_botonera, ayuda, orden, ci_predep, implicito, defecto, display_datos_cargados, grupo, accion, accion_imphtml_debug, accion_vinculo_carpeta, accion_vinculo_item, accion_vinculo_objeto, accion_vinculo_popup, accion_vinculo_popup_param, accion_vinculo_target, accion_vinculo_celda, accion_vinculo_servicio, es_seleccion_multiple, es_autovinculo) VALUES (
	...
	'1', --maneja_datos
	'1', --sobre_fila
	'Está seguro de FINALIZAR el servicio, NO podrá realizar más cambios ?', --confirmacion
	NULL, --estilo
	'apex', --imagen_recurso_origen
	'tilde', --imagen
	'0', --en_botonera
	'Finalizar Servicio', --ayuda
	'2', --orden
	NULL, --ci_predep
	NULL, --implicito
	NULL, --defecto
...
INSERT INTO apex_objeto_eventos (proyecto, evento_id, objeto, identificador, etiqueta, maneja_datos, sobre_fila, confirmacion, estilo, imagen_recurso_origen, imagen, en_botonera, ayuda, orden, ci_predep, implicito, defecto, display_datos_cargados, grupo, accion, accion_imphtml_debug, accion_vinculo_carpeta, accion_vinculo_item, accion_vinculo_objeto, accion_vinculo_popup, accion_vinculo_popup_param, accion_vinculo_target, accion_vinculo_celda, accion_vinculo_servicio, es_seleccion_multiple, es_autovinculo) VALUES (
	...
	'1', --maneja_datos
	'1', --sobre_fila
	'Está seguro de ANULAR el servicio, NO podrá realizar más cambios y NO se tendrá en cuenta para la Liquidación?', --confirmacion
	NULL, --estilo
	'apex', --imagen_recurso_origen
	'error', --imagen
	'0', --en_botonera
	'Anular el Servicio x Error', --ayuda
	'3', --orden
	NULL, --ci_predep
	NULL, --implicito
	NULL, --defecto
...
INSERT INTO apex_objeto_cuadro (objeto_cuadro_proyecto, objeto_cuadro, titulo, subtitulo, sql, columnas_clave, columna_descripcion, clave_dbr, archivos_callbacks, ancho, ordenar, paginar, tamano_pagina, tipo_paginado, mostrar_total_registros, eof_invisible, eof_customizado, siempre_con_titulo, exportar_paginado, exportar, exportar_rtf, pdf_propiedades, pdf_respetar_paginacion, asociacion_columnas, ev_seleccion, ev_eliminar, dao_nucleo_proyecto, dao_nucleo, dao_metodo, dao_parametros, desplegable, desplegable_activo, scroll, scroll_alto, cc_modo, cc_modo_anidado_colap, cc_modo_anidado_totcol, cc_modo_anidado_totcua) VALUES (
	'lavautos', --objeto_cuadro_proyecto
	'12200', --objeto_cuadro
	NULL, --titulo
	NULL, --subtitulo
	NULL, --sql
	'serenc_id, serenc_vehiculo, serenc_tipo_vehiculo', --columnas_clave
	...
	'0', --eof_invisible
	'Sin SERVICIOS REGISTRADOS EN EL DIA con la Información suministrada', --eof_customizado
...
INSERT INTO apex_objeto_cuadro_cc (objeto_cuadro_proyecto, objeto_cuadro, objeto_cuadro_cc, identificador, descripcion, orden, columnas_id, columnas_descripcion, pie_contar_filas, pie_mostrar_titular, pie_mostrar_titulos, imp_paginar, modo_inicio_colapsado) VALUES (
	'lavautos', --objeto_cuadro_proyecto
	'12200', --objeto_cuadro
	'2770', --objeto_cuadro_cc
	'serenc_tipo_vehiculo', --identificador
	'Tipo Vehículo', --descripcion
	'1', --orden
	'serenc_tipo_vehiculo', --columnas_id
	'tipveh_nombre', --columnas_descripcion
	'0', --pie_contar_filas
...
INSERT INTO apex_objeto_ei_cuadro_columna (objeto_cuadro_proyecto, objeto_cuadro, objeto_cuadro_col, clave, orden, titulo, estilo_titulo, estilo, ancho, formateo, vinculo_indice, no_ordenar, mostrar_xls, mostrar_pdf, pdf_propiedades, desabilitado, total, total_cc, usar_vinculo, vinculo_carpeta, vinculo_item, vinculo_popup, vinculo_popup_param, vinculo_target, vinculo_celda, vinculo_servicio, permitir_html, grupo, evento_asociado) VALUES (
	...
	NULL, --vinculo_servicio
	'0', --permitir_html
	'Datos Propietario', --grupo
	NULL  --evento_asociado
);
INSERT INTO apex_objeto_ei_cuadro_columna (objeto_cuadro_proyecto, objeto_cuadro, objeto_cuadro_col, clave, orden, titulo, estilo_titulo, estilo, ancho, formateo, vinculo_indice, no_ordenar, mostrar_xls, mostrar_pdf, pdf_propiedades, desabilitado, total, total_cc, usar_vinculo, vinculo_carpeta, vinculo_item, vinculo_popup, vinculo_popup_param, vinculo_target, vinculo_celda, vinculo_servicio, permitir_html, grupo, evento_asociado) VALUES (
	'lavautos', --objeto_cuadro_proyecto
	'12200', --objeto_cuadro
	'16866', --objeto_cuadro_col
	'total_servicios', --clave
	'11', --orden
	...
	NULL, --vinculo_servicio
	'0', --permitir_html
	'TOTALES X SERVICIO', --grupo
	NULL  --evento_asociado
);
INSERT INTO apex_objeto_ei_cuadro_columna (objeto_cuadro_proyecto, objeto_cuadro, objeto_cuadro_col, clave, orden, titulo, estilo_titulo, estilo, ancho, formateo, vinculo_indice, no_ordenar, mostrar_xls, mostrar_pdf, pdf_propiedades, desabilitado, total, total_cc, usar_vinculo, vinculo_carpeta, vinculo_item, vinculo_popup, vinculo_popup_param, vinculo_target, vinculo_celda, vinculo_servicio, permitir_html, grupo, evento_asociado) VALUES (
	'lavautos', --objeto_cuadro_proyecto
	'12200', --objeto_cuadro
	'16867', --objeto_cuadro_col
	'total_compensacion', --clave
	'12', --orden
	'Compensación [50%]', --titulo
	'ei-cuadro-col-tit', --estilo_titulo
	'col-num-p1', --estilo
	NULL, --ancho
	'7', --formateo
...
INSERT INTO apex_objeto_ei_cuadro_columna (objeto_cuadro_proyecto, objeto_cuadro, objeto_cuadro_col, clave, orden, titulo, estilo_titulo, estilo, ancho, formateo, vinculo_indice, no_ordenar, mostrar_xls, mostrar_pdf, pdf_propiedades, desabilitado, total, total_cc, usar_vinculo, vinculo_carpeta, vinculo_item, vinculo_popup, vinculo_popup_param, vinculo_target, vinculo_celda, vinculo_servicio, permitir_html, grupo, evento_asociado) VALUES (
	'lavautos', --objeto_cuadro_proyecto
	'12200', --objeto_cuadro
	'16868', --objeto_cuadro_col
	'total_suministreos', --clave
	'13', --orden
	'Suministros [12%]', --titulo
	'ei-cuadro-col-tit', --estilo_titulo
	'col-num-p1', --estilo
	NULL, --ancho
	'7', --formateo
...
INSERT INTO apex_objeto_ei_cuadro_columna (objeto_cuadro_proyecto, objeto_cuadro, objeto_cuadro_col, clave, orden, titulo, estilo_titulo, estilo, ancho, formateo, vinculo_indice, no_ordenar, mostrar_xls, mostrar_pdf, pdf_propiedades, desabilitado, total, total_cc, usar_vinculo, vinculo_carpeta, vinculo_item, vinculo_popup, vinculo_popup_param, vinculo_target, vinculo_celda, vinculo_servicio, permitir_html, grupo, evento_asociado) VALUES (
	'lavautos', --objeto_cuadro_proyecto
	'12200', --objeto_cuadro
	'16870', --objeto_cuadro_col
	'serenc_fecha', --clave
	'2', --orden
	'Fecha Servicio', --titulo
	'ei-cuadro-col-tit', --estilo_titulo
	'4', --estilo
	NULL, --ancho
	'1', --formateo
...
INSERT INTO apex_objeto_ei_cuadro_columna (objeto_cuadro_proyecto, objeto_cuadro, objeto_cuadro_col, clave, orden, titulo, estilo_titulo, estilo, ancho, formateo, vinculo_indice, no_ordenar, mostrar_xls, mostrar_pdf, pdf_propiedades, desabilitado, total, total_cc, usar_vinculo, vinculo_carpeta, vinculo_item, vinculo_popup, vinculo_popup_param, vinculo_target, vinculo_celda, vinculo_servicio, permitir_html, grupo, evento_asociado) VALUES (
	'lavautos', --objeto_cuadro_proyecto
	'12200', --objeto_cuadro
	'16874', --objeto_cuadro_col
	'veh_propietario_nombres', --clave
	'4', --orden
	'Nombre', --titulo
	'ei-cuadro-col-tit', --estilo_titulo
	'col-tex-p1', --estilo
...
INSERT INTO apex_objeto_ei_cuadro_columna (objeto_cuadro_proyecto, objeto_cuadro, objeto_cuadro_col, clave, orden, titulo, estilo_titulo, estilo, ancho, formateo, vinculo_indice, no_ordenar, mostrar_xls, mostrar_pdf, pdf_propiedades, desabilitado, total, total_cc, usar_vinculo, vinculo_carpeta, vinculo_item, vinculo_popup, vinculo_popup_param, vinculo_target, vinculo_celda, vinculo_servicio, permitir_html, grupo, evento_asociado) VALUES (
	'lavautos', --objeto_cuadro_proyecto
	'12200', --objeto_cuadro
	'16875', --objeto_cuadro_col
	'veh_propietario_identificacion', --clave
	'5', --orden
